---
name: Documentation engineer subagent
description: Code-faithful technical documentation subagent
kind: subagent
size_mb: 0
category: documentation
pinned_models: ["gpt-5.3-codex-spark"]
install: |
  # Documentation engineer subagent — vendored byte-verbatim from VoltAgent/awesome-codex-subagents
  ...
  cat > "$HOME/.codex/agents/documentation-engineer.toml" <<'AGENT'
  ...
  """
  AGENT
source: https://github.com/VoltAgent/awesome-codex-subagents/blob/5605c9c18b3687993919d6cc467af4a34898fee2/categories/06-developer-experience/documentation-engineer.toml
---

# Documentation engineer subagent

Code-faithful technical documentation subagent. Vendored from the community
...
prompt, e.g. "use the documentation-engineer subagent to ...". The agent definition
lands at ~/.codex/agents/documentation-engineer.toml.
