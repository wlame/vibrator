...
func writeHeader(b *bytes.Buffer, spec Spec) {
	...
	// in the catalog stage so multi-line shell snippets don't get parsed
...
`)
	...
	for _, e := range entries {
		...
		writeCatalogInstall(b, e.Install)
		b.WriteString("\n")
	}
}

// writeCatalogInstall wraps a catalog entry's shell install snippet in
// a BuildKit heredoc RUN block. The catalog `install:` field is plain
...
// host's docker build.
func writeCatalogInstall(b *bytes.Buffer, install string) {
