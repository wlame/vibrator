...
#   vibrate build-dockerfile --harness=pi --profile=minimal --shell=zsh
...
ENV VIBRATOR_HARNESS="pi"
ENV VIBRATOR_PROFILE="minimal"
ENV VIBRATOR_FEATURES_LIST="node"
